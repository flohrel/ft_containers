...
class VectorTestSuite : public CxxTest::TestSuite
{
	public:
		...
		{
			v2.insert(v2.begin() + 2, 38, 666);
			TS_ASSERT_EQUALS(v2[0], 42);
			TS_ASSERT_EQUALS(v2[1], 21);
			TS_ASSERT_EQUALS(v2[2], 666);
			TS_ASSERT_EQUALS(v2[6], 666);
			TS_ASSERT_EQUALS(v2[39], 666);
			TS_ASSERT_EQUALS(v2[40], 42);
			TS_ASSERT_EQUALS(v2[41], 42);
