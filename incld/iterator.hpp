...
namespace ft
{
			...
			typename iterator_traits< Iterator >::reference >
	{
		...
		public:
			...
			operator random_access_iterator< const Iterator >() const { return _current; }

			template< typename IteratorL, typename IteratorR >
			bool	operator==( const random_access_iterator<Iterator>& rhs )
			...
			friend random_access_iterator< Iter >
			...
			template< typename IteratorL, typename IteratorR >
			friend typename random_access_iterator< IteratorL >::difference_type
